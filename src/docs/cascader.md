...
<div class="demo-block demo-cascader">
   <div class="block">
  <span class="demonstration">默认 click 触发子菜单</span>
  <yt-cascader
    v-model="value1"
    :options="options"
    @change="handleChange"></yt-cascader>
</div>
<div class="block">
...
<script>
  ...
  export default {
    ...
    created(){
      ...
      this.options3 = [...this.options];
      this.options4 = [...this.options]
      this.options5 = [...this.options]
      this.options6 = [...this.options]
      this.options7 = [...this.options]
      this.options8 = [...this.options]
      this.$set(this.options2[0],"disabled",true)
    },
    methods: {
      handleChange(value) {
        console.log(value);
...
<div class="demo-block">
 <yt-cascader :options="options2"></yt-cascader>
</div>

:::demo 
```html
<yt-cascader :options="options"></yt-cascader>
...
<div class="demo-block">
  <yt-cascader :options="options3" clearable></yt-cascader>
</div>

:::demo
```html
<yt-cascader :options="options" clearable></yt-cascader>
...
<div class="demo-block">
 <yt-cascader v-model="value4" :options="options4"  @change="handleChange4" :show-all-levels="false"></yt-cascader>
</div>

:::demo 
```html
<yt-cascader :options="options" :show-all-levels="false"></yt-cascader>
...
<div class="demo-block">
  <yt-cascader :props="props"></yt-cascader>
</div>
...
```html
<yt-cascader-panel :options="options"></yt-cascader-panel>
