...
<div class="demo-block">
  <yt-transfer v-model="value" :data="data"></yt-transfer>
</div>
<script>
  export default {
    data() {
...
<div class="demo-block">
  ...
  <div style="text-align: center">
    <yt-transfer
      ...
      @change="handleChange"
      :data="data">
      <yt-button class="transfer-footer" slot="left-footer" size="small">操作</yt-button>
      <yt-button class="transfer-footer" slot="right-footer" size="small">操作</yt-button>
    </yt-transfer>
  </div>
