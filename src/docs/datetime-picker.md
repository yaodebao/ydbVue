  ...
  export default {
    data() {
      return {
        ...
        value21: [new Date(2000, 10, 10, 10, 10), new Date(2000, 10, 11, 10, 10)],
        value22: '',
        value1: '',
        value2: '',
        value3: '',
...
| format | 显示在输入框中的格式 | string | 见[日期格式] | yyyy-MM-dd HH:mm:ss |
...
| prefix-icon | 自定义头部图标的类名 | string | — | yt-icon-date |
