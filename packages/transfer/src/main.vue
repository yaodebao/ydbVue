<template>
  <div class="yt-transfer">
    ...
    <div class="yt-transfer__buttons">
      <yt-button
        type="primary"
        :class="['yt-transfer__button', hasButtonTexts ? 'is-with-texts' : '']"
        @click.native="addToLeft"
        :disabled="rightChecked.length === 0">
        <i class="yt-icon-arrow-left"></i>
