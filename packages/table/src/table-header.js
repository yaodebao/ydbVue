import Vue from 'vue';
import { hasClass, addClass, removeClass } from '../../../YTJS/utils/dom';
...
export default {
                    ...
                    <div class={ ['cell', column.filteredValue && column.filteredValue.length > 0 ? 'highlight' : '', column.labelClassName] }>
                      ...
                      }
                      {
                        column.filterable ? (<span
                          class="yt-table__column-filter-trigger"
                          on-click={ ($event) => this.handleFilterClick($event, column) }>
                          <i class={ ['yt-icon-arrow-down', column.filterOpened ? 'yt-icon-arrow-up' : ''] }></i>
                        </span>) : ''
                      }
                    </div>
                  </th>))
  ...
  methods: {
    ...
    handleFilterClick(event, column) {
      ...
      cell = cell.querySelector('.yt-table__column-filter-trigger') || cell;
