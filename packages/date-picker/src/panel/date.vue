<template>
  <transition name="yt-zoom-in-top" @after-enter="handleEnter" @after-leave="handleLeave">
    <div
      v-show="visible"
      class="yt-picker-panel yt-date-picker yt-popper"
      :class="[{
      ...
      <div class="yt-picker-panel__body-wrapper">
        ...
        <div class="yt-picker-panel__body">
          <div class="yt-date-picker__time-header" v-if="showTime">
            <span class="yt-date-picker__editor-wrap">
              <yt-input
            ...
            <span class="yt-date-picker__editor-wrap" v-clickoutside="handleTimePickClose">
              <yt-input
                ref="input"
          ...
          <div
            class="yt-date-picker__header"
            :class="{ 'yt-date-picker__header--bordered': currentView === 'year' || currentView === 'month' }"
            v-show="currentView !== 'time'">
            <button
              type="button"
              @click="prevYear"
              :aria-label="t(`el.datepicker.prevYear`)"
              class="yt-picker-panel__icon-btn yt-date-picker__prev-btn yt-icon-d-arrow-left">
            </button>
            <button
              type="button"
              @click="prevMonth"
              ...
              class="yt-picker-panel__icon-btn yt-date-picker__prev-btn yt-icon-arrow-left">
            </button>
            <span
              @click="showYearPicker"
              role="button"
              class="yt-date-picker__header-label">{{ yearLabel }}</span>
            <span
              @click="showMonthPicker"
              v-show="currentView === 'date'"
              role="button"
              class="yt-date-picker__header-label"
              :class="{ active: currentView === 'month' }">{{t(`el.datepicker.month${ month + 1 }`)}}</span>
            <button
              type="button"
              @click="nextYear"
              :aria-label="t(`el.datepicker.nextYear`)"
              class="yt-picker-panel__icon-btn yt-date-picker__next-btn yt-icon-d-arrow-right">
            </button>
            <button
              type="button"
              @click="nextMonth"
              ...
              class="yt-picker-panel__icon-btn yt-date-picker__next-btn yt-icon-arrow-right">
            </button>
          </div>

          <div class="yt-picker-panel__content">
            <date-table
              v-show="currentView === 'date'"
              @pick="handleDatePick"
...
<script type="text/babel">
  ...
  export default {
    ...
    components: {
      TimePicker, YearTable, MonthTable, DateTable, ytInput, ytButton
    },
