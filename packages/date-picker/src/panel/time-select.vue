<template>
  <transition name="yt-zoom-in-top" @before-enter="handleMenuEnter" @after-leave="$emit('dodestroy')">
    <div
      ref="popper"
      v-show="visible"
      :style="{ width: width + 'px' }"
      :class="popperClass"
      class="yt-picker-panel time-select yt-popper">
      <yt-scrollbar noresize wrap-class="yt-picker-panel__content">
  ...
  export default {
    ...
    methods: {
      ...
      scrollToOption(selector = '.selected') {
        const menu = this.$refs.popper.querySelector('.yt-picker-panel__content');
