<template>
  <transition name="yt-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="yt-picker-panel yt-date-range-picker yt-popper"
      :class="[{
        'has-sidebar': $slots.sidebar || shortcuts,
        'has-time': showTime
      }, popperClass]">
      <div class="yt-picker-panel__body-wrapper">
        <slot name="sidebar" class="yt-picker-panel__sidebar"></slot>
        <div class="yt-picker-panel__sidebar" v-if="shortcuts">
          <button
            type="button"
            class="yt-picker-panel__shortcut"
            v-for="(shortcut, key) in shortcuts"
            :key="key"
            @click="handleShortcutClick(shortcut)">{{shortcut.text}}</button>
        </div>
        <div class="yt-picker-panel__body">
          <div class="yt-date-range-picker__time-header" v-if="showTime">
            <span class="yt-date-range-picker__editors-wrap">
              <span class="yt-date-range-picker__time-picker-wrap">
                <yt-input
                  size="small"
                  :disabled="rangeState.selecting"
                  ref="minInput"
                  :placeholder="t('el.datepicker.startDate')"
                  class="yt-date-range-picker__editor"
                  :value="minVisibleDate"
                  @input="val => handleDateInput(val, 'min')"
                  @change="val => handleDateChange(val, 'min')" />
              </span>
              <span class="yt-date-range-picker__time-picker-wrap" v-clickoutside="handleMinTimeClose">
                <yt-input
                  size="small"
                  class="yt-date-range-picker__editor"
                  :disabled="rangeState.selecting"
            ...
            <span class="yt-icon-arrow-right"></span>
            <span class="yt-date-range-picker__editors-wrap is-right">
              <span class="yt-date-range-picker__time-picker-wrap">
                <yt-input
                  size="small"
                  class="yt-date-range-picker__editor"
              ...
              <span class="yt-date-range-picker__time-picker-wrap" v-clickoutside="handleMaxTimeClose">
                <yt-input
                  size="small"
                  class="yt-date-range-picker__editor"
                  :disabled="rangeState.selecting"
          ...
          <div class="yt-picker-panel__content yt-date-range-picker__content is-left">
            <div class="yt-date-range-picker__header">
              <button
                type="button"
                @click="leftPrevYear"
                class="yt-picker-panel__icon-btn yt-icon-d-arrow-left"></button>
              <button
                type="button"
                @click="leftPrevMonth"
                class="yt-picker-panel__icon-btn yt-icon-arrow-left"></button>
              <button
                type="button"
                @click="leftNextYear"
                v-if="unlinkPanels"
                ...
                class="yt-picker-panel__icon-btn yt-icon-d-arrow-right"></button>
              <button
                type="button"
                @click="leftNextMonth"
                v-if="unlinkPanels"
                ...
                class="yt-picker-panel__icon-btn yt-icon-arrow-right"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
          ...
          <div class="yt-picker-panel__content yt-date-range-picker__content is-right">
            <div class="yt-date-range-picker__header">
              <button
                type="button"
                @click="rightPrevYear"
      ...
      <div class="yt-picker-panel__footer" v-if="showTime">
        <yt-button
          size="mini"
          type="text"
          class="yt-picker-panel__link-btn"
          @click="handleClear">
...
<script type="text/babel">
  ...
  export default {
    ...
    components: { TimePicker, DateTable, ytInput, ytButton }
  };
</script>
