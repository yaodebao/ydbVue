<template>
  <transition name="yt-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="yt-time-panel yt-popper"
      :class="popperClass">
      <div class="yt-time-panel__content" :class="{ 'has-seconds': showSeconds }">
        <time-spinner
          ref="spinner"
          @change="handleChange"
...
<script type="text/babel">
  import { limitTimeRange, isDate, clearMilliseconds, timeWithinRange } from '../../../../YTJS/utils/date-util';
