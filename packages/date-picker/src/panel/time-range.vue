<template>
  <transition
    ...
    <div
      v-show="visible"
      class="yt-time-range-picker yt-picker-panel yt-popper"
      :class="popperClass">
      <div class="yt-time-range-picker__content">
        <div class="yt-time-range-picker__cell">
          <div class="yt-time-range-picker__header">{{ t('el.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="yt-time-range-picker__body yt-time-panel__content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="yt-time-range-picker__cell">
          <div class="yt-time-range-picker__header">{{ t('el.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="yt-time-range-picker__body yt-time-panel__content">
            <time-spinner
      ...
      <div class="yt-time-panel__footer">
        <button
          type="button"
          class="yt-time-panel__btn cancel"
          @click="handleCancel()">{{ t('el.datepicker.cancel') }}</button>
        <button
          type="button"
          class="yt-time-panel__btn confirm"
          @click="handleConfirm()"
