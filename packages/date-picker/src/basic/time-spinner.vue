<template>
  <div class="yt-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <yt-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="yt-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="yt-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="yt-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="yt-time-spinner__arrow yt-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="yt-time-spinner__arrow yt-icon-arrow-down"></i>
        <ul class="yt-time-spinner__list" ref="hours">
          <li
            class="yt-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="yt-time-spinner__arrow yt-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="yt-time-spinner__arrow yt-icon-arrow-down"></i>
        <ul class="yt-time-spinner__list" ref="minutes">
          <li
            class="yt-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="yt-time-spinner__arrow yt-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="yt-time-spinner__arrow yt-icon-arrow-down"></i>
        <ul class="yt-time-spinner__list" ref="seconds">
          <li
...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from '../../../../YTJS/utils/date-util';
