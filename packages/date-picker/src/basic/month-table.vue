<template>
  <table @click="handleMonthTableClick" @mousemove="handleMouseMove" class="yt-month-table">
    <tbody>
...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from '../../../../YTJS/utils/date-util';
  import { hasClass } from '../../../../YTJS/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from '../../../../YTJS/utils/util';
