<script>
  ...
  import { isEqual } from '../../../YTJS/utils/util';
  ...
  export default {
    ...
    methods: {
      ...
      renderCheckIcon(h) {
        return (
          <i class="yt-icon-check yt-cascader-node__prefix"></i>
        );
      },

      renderLoadingIcon(h) {
        return (
          <i class="yt-icon-loading yt-cascader-node__postfix"></i>
        );
      },

      renderExpandIcon(h) {
        return (
          <i class="yt-icon-arrow-right yt-cascader-node__postfix"></i>
        );
      },
      ...
      renderContent(h) {
        ...
        return (
          <span class="yt-cascader-node__label">{ vnode || node.label }</span>
        );
      }
    },
