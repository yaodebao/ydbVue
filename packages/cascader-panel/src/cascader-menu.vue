...
export default {
  ...
  methods: {
    ...
    renderEmptyText(h) {
      return (
        <div class="yt-cascader-menu__empty-text">{ this.t('el.cascader.noData') }</div>
      );
    },
    renderNodeList(h) {
      const { menuId } = this;
      ...
      return [
        ...nodes,
        isHoverMenu ? <svg ref='hoverZone' class='yt-cascader-menu__hover-zone'></svg> : null
      ];
    }
  },
  ...
  render(h) {
    ...
    return (
      <yt-scrollbar
        ...
        role="menu"
        id={ menuId }
        class="yt-cascader-menu"
        wrap-class="yt-cascader-menu__wrap"
        view-class={{
          'yt-cascader-menu__list': true,
          'is-empty': isEmpty
        }}
        { ...events }>
