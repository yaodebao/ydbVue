<template>
  <div
    class="yt-slider"
    :class="{ 'is-vertical': vertical, 'yt-slider--with-input': showInput }"
    role="slider"
    :aria-valuemin="min"
    :aria-valuemax="max"
  ...
  >
    ...
    <div
      class="yt-slider__runway"
      :class="{ 'show-input': showInput, 'disabled': sliderDisabled }"
      :style="runwayStyle"
      @click="onSliderClick"
      ref="slider">
      <div
        class="yt-slider__bar"
        :style="barStyle">
      </div>
      <slider-button
        :vertical="vertical"
      ...
      <template v-if="markList.length > 0">
        <div>
          <div
            ...
            class="yt-slider__stop yt-slider__marks-stop"
            :key="key">
          </div>
        </div>
        <div class="yt-slider__marks">
          <slider-marker
...
<script type="text/babel">
  import ytInputNumber from '../../input-number';
        ...
        if (this.range && Array.isArray(val)) {
          if (val[1] < this.min) {
            ...
            if (this.valueChanged()) {
              this.dispatch('ytFormItem', 'yt.form.change', [this.minValue, this.maxValue]);
